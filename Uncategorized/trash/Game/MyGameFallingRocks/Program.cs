...
class FallingRocks
{
    ...
    static void Main(string[] args)
    {
        ...
        int gameSpeed = 100;
        int lives = 5;
        Console.WriteLine("What Game Speed Do you want ?");
        Console.WriteLine();
        Console.WriteLine("   1 - Slow \n   2 - Medium \n   3 - Fast \n   4 - Impossible");
        gameSpeed = 500 - 110 * (Convert.ToInt32(Console.ReadLine()));
        string gameSp = "Slow";
        if (gameSpeed == 500 - 110 * 2)
        {
            gameSp = "Medium";
        }
        if (gameSpeed == 500 - 110 * 3)
        {
            gameSp = "Fast";
        }
        if (gameSpeed == 500 - 110 * 4)
        {
            gameSp = "Impossible";
        }
        Console.WriteLine("   How many lifes do you want?");
        ...
        while (true)
        {
            ...
            PrintOnScreen(43, 9, "Difficulty : ", ConsoleColor.Green);
            PrintOnScreen(49, 10, gameSp, ConsoleColor.Green);
            score++;
            //speed
