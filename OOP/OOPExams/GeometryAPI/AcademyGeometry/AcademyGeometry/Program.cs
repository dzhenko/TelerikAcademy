...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure,IAreaMeasurable,IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            return (2 * GetBaseArea()) + 2 * Math.PI * this.Radius * this.GetHeight();
        }
    ...
    public class AdvancedFigureController : FigureController
    {
                ...
                case "circle":
                    {
                        ...
                        this.currentFigure = new Circle(centre, radius);
                        break;
                    }
                case "cylinder":
                    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        var areaFigure = this.currentFigure as IAreaMeasurable;
                        if (areaFigure == null)
                        {
                        ...
                        {
                            Console.WriteLine("{0:0.00}", areaFigure.GetArea());
                        }
                        break;
                    }
                case "volume":
                    {
                        var areaFigure = this.currentFigure as IVolumeMeasurable;
                        if (areaFigure == null)
                        {
                            Console.WriteLine("undefined");
                        }
                        ...
                        {
                            Console.WriteLine("{0:0.00}", areaFigure.GetVolume());
                        }
                        break;
                    }
                case "normal":
                    {
                        var areaFigure = this.currentFigure as IFlat;
                        if (areaFigure == null)
                        {
                            Console.WriteLine("undefined");
                        }
                        ...
                        {
                            Console.WriteLine(areaFigure.GetNormal());
                        }
                        break;
                    }
                default: break;
